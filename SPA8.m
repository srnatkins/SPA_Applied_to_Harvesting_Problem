...
% The initial guess of the switches, y2(0), and lambda1(L) came from SPA6.m
% The switches corresponding to singular arc for the 6 switch case are
...
h3= 0;                     % h(x) = 0    on (s3,s4) 
h4 = 0.5;                  % h(x) = 1/2  on (s4,s5) <- the singular arc
h5 = 0;                    % h(x) = 0    on (s5,s6)
h6 = hmax;                 % h(x) = hmax on (s6,s7)
h7 = 0;                    % h(x) = 0    on (s7,s8)
h8 = hmax;                 % h(x) = hmax on (s8,s9) where s9=L=10
h = [h0; h1; h2;h3; h4; h5; h6;h7;h8];
N = length(h);            
y20 = 0.192080841873656;
y20save = y20;
lam1L = 1.301535317935051;
ds = L/1000;                    %delta = 0.01
dxstep = 1.e-3;
errtol = 1.e-10;
dxlam = dxstep;
y20save = y20;
%lam1L = 1.308873618199914;
%other parameters
...
s4 = s3+epsilon;
s5 = 6.642733319818394-epsilon;
s6 = 6.642733319818394;
s7 = 6.896896766723736;
s8 = 8.231878237927704;
s = [s1;s2;s3;s4;s5;s6;s7;s8];
ssave=[s1;s2;s3;s4;s5;s6;s7;s8];
olds = s;
...
%interior of [s^{k}_i-ds,s^{k}_i+ds] for all i=1,...,8 or until a maximum 
